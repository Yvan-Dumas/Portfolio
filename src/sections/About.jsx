    ...
    return (
        <section id="about">
            ...
            <div className="flex flex-col items-center center md:flex-row px-10 md:pl-20 gap-10">
                <p className="mt-10 md:mt-15 whitespace-pre-line">{t('about.description')}</p>
                <img src={chopperImg} alt="3D modeling of Tony Tony Chopper from One Piece" className="flex-none w-[20vw] min-w-[150px] max-w-[500px] object-contain aspect-auto drop-shadow-2xl animate-float"/>
            </div>
